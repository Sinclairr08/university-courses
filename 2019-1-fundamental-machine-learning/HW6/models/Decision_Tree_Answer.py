    ...
    def Find_Best_Feature(self, df):
        ...
        # ============       Edit here      ==================
            ...
            # Numeric Feature Case
                ...
                impurity += impurity_func(splited_Y_data_large, self.criterion) * len(splited_Y_data_large)
                impurity += impurity_func(splited_Y_data_less, self.criterion) * len(splited_Y_data_less)
